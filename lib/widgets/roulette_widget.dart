...
class RouletteWidget extends StatefulWidget {
  const RouletteWidget({Key? key, required this.rouletteItems}) : super(key: key);
...
class _RouletteWidgetState extends State<RouletteWidget> {
  ...
  Widget build(BuildContext context) {
    final group = RouletteGroup.uniform(widget.rouletteItems.length, textBuilder: (index) => (index + 1).toString());
    ...
    return Column(
      ...
      children: [
        if (spinResult != null)
          Text(
            AppLocalizations.of(context)!.resultSpinResult(spinResult!),
            style: Theme.of(context).textTheme.headlineMedium,
          ),
        if (spinResult == null)
          Text(AppLocalizations.of(context)!.spinTheWheel, style: Theme.of(context).textTheme.headlineMedium),
        SizedBox(
          height: 300,
          child: Stack(
                ...
                child: Padding(
                  ...
                  child: Roulette(
                    ...
                    style: RouletteStyle(
                      ...
                      centerStickerColor: Theme.of(context).colorScheme.onSurface,
                    ),
                  ),
                ),
              ),
              ...
              Positioned(
                ...
                child: FloatingActionButton(
                  ...
                  onPressed: () {
                    ...
                    controller.rollTo(target, duration: duration, offset: Random().nextDouble());
                    () async {
...
class Arrow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      width: 20,
      height: 36,
      child: CustomPaint(painter: _ArrowPainter(color: Theme.of(context).colorScheme.tertiary)),
    );
  }
}
